...
if ($id != "") {
	...
	$sel_colab = "SELECT * FROM tab_cnv WHERE id_colab = $id";
	...
	for ($i=0; $i < count($doctos_faltantes); $i++) {
...
<table cellpadding="0" cellspacing="0" border="0" width="710">
    ...
    <tr>
    	<td>
			...
			?>
            <br /><br /><br><br>
			Fico no aguardo o mais breve possível da documentação solicitada.<br><br><br>
